...
| 序号 | 题目 | 难度 | 说明 | 是否完成 |
|:----:|------|:----:|------|:-------:|
| 303 | 区域和检索 - 数组不可变 | 简单 | 一维前缀和快速求区间和 | ✓ |
| 304 | 二维区域和检索 - 矩阵不可变 | 中等 | 二维前缀和矩阵快速求块和 | ✗ |
| 560 | 和为 K 的子数组 | 中等 | 前缀和+哈希表计数 | ✓ |
| 437 | 路径总和 III | 中等 | 树上前缀和+DFS回溯 | ✓ |
| 523 | 连续的子数组和 | 中等 | 前缀和取模+哈希表判连续和倍数 | ✗ |
| 525 | 连续数组 | 中等 | 前缀和+哈希表（0转-1找等长） | ✗ |
| 724 | 寻找数组的中心下标 | 简单 | 前缀和求左右和相等的索引 | ✓ |
| 930 | 和相同的二元子数组 | 中等 | 前缀和+哈希表（同560思路） | ✗ |
| 974 | 和可被 K 整除的子数组 | 中等 | 前缀和取模+哈希表 | ✗ |
| 1732 | 找到最高海拔 | 简单 | 前缀和求最大值 | ✓ |
